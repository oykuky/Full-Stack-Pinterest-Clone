        ...
        <div className='flex justify-end mb-5'>
            <button onClick={()=>onSave()}
             className='bg-red-500 p-2 text-white font-semibold px-3  rounded-lg'>
              {loading? 
               <Image src="/loading-indicator.png" width={30} height={30} alt='loading'
           ...
           <UploadImage setFile={(file)=>setFile(file)} />
            ...
            <div className='col-span-2'>
                <div className='w-[100%]'>
                    ...
                    className=' outline-none  w-full mt-8 pb-4 text-[15px]
                    border-b-[2px] border-gray-400 placeholder-gray-400'/>

                    <input type='text' 
                    placeholder='Add a Destination Link'
                    onChange={(e)=>setLink(e.target.value)}
                    className='outline-none w-full mt-[90px] pb-4 border-b-[2px]
                     border-gray-400 placeholder-gray-400'/>
                </div>
            </div>
        </div>
